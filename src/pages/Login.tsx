  ...
  return (
    <div className="min-h-screen bg-[#f6f7f8] dark:bg-[#000000] text-slate-900 dark:text-white flex flex-col items-center justify-center p-6 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-md relative z-10">
        {!showForm ? (
          <div className="flex flex-col items-center text-center space-y-8 animate-fade-in animate-slide-up">
          ...
          <div className="bg-white dark:bg-[#1c1c1e] p-8 rounded-[2.5rem] shadow-2xl border border-white/50 dark:border-white/5 animate-fade-in animate-slide-up">
            <div className="mb-8">
              <button 
